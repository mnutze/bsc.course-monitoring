ccm.files[ "demo.js" ] = {
    "demo": {
        ...
        "components.monitor_latest_activities": [ "ccm.component", "https://mnutze.github.io/bsc.monitors/monitor_latest_activities/ccm.monitor_latest_activities.js",
            ["ccm.get", "https://mnutze.github.io/bsc.monitors/monitor_latest_activities/resources/configs.js", "demo"] ],
        ...
        "ignore": {
                    ...
                    "widgets": [
                        ...
                        // Activity Distribution @TODO generalize
                        {
                            ...
                            "config": {
                                ...
                                "range": {"enabled": true, "range": "last 6 month"}
                            },
            ...
            "process": {
                "accumulated_activities": [ "ccm.load", { "url": "https://mnutze.github.io/bsc.monitor/assets/monitor.accumulated_activities.js", "type": "js" } ],
                "solutions_point_map": [ "ccm.load", { "url": "https://mnutze.github.io/bsc.monitor/assets/monitor.solutions_point_map.js", "type": "js" } ],
                "kanban": [ "ccm.load", { "url": "https://mnutze.github.io/bsc.monitor/assets/monitor.kanban.js", "type": "js" } ],
                "learners": [ "ccm.load", { "url": "https://mnutze.github.io/bsc.monitor/assets/monitor.learners.js", "type": "js" } ],
                "teams": [ "ccm.load", { "url": "https://mnutze.github.io/bsc.monitor/assets/monitor.teams.js", "type": "js" } ],
                "team_members": [ "ccm.load", { "url": "https://mnutze.github.io/bsc.monitor/assets/widget.team_members.js", "type": "js" } ],
            },
            ...
            "widgets": {
                ...
                "course_statistics": {
                    ...
                    "config": {
                        // initial configuration
                        "worker": "https://mnutze.github.io/bsc.monitor/assets/worker.course_statistics.js",
                        "render": { "key": "custom" },
                        "subject": {}
                    },
                    "options": {
                ...
                "latest_subject_activities": {
                    ...
                    "config.stores": {}, // prevent loading data by component
                ...
                "learner_exam_admission":{
                    ...
                    "config": {
                        // initial configuration
                        "worker": "https://mnutze.github.io/bsc.monitor/assets/worker.learner_progress.js",
                ...
                "lesson_completion": {
                    ...
                    "component": "monitor",
                    "config": {
                        "worker": "https://mnutze.github.io/bsc.monitor/assets/worker.lesson_completion.js",
                        "render": { "key": "highcharts" },
                        "incompleteLog": true
                    },
                    "scroll": { "y": false },
                ...
                "subject_activity_over_time_range": {
                    ...
                    "config": {
                        ...
                        "subject": {},
                        // runtime configuration
                        "interval": { "enabled": true, "current": "1d", "exclude": [] },
                        "range": { "enabled": true, "range": "last 6 month" },
                    },
                    "options": { "selection": true },
                    "scroll": { "y": false },
                ...
                "subject_communication": {
                    ...
                    "config": {
                        // initial configuration
                        "worker": "https://mnutze.github.io/bsc.monitor/assets/worker.communication_analysis.js",
                ...
                "subject_total_activities": {
                    ...
                    "config": {
                        ...
                        "selection": true,
                        "subject": { "key": "user.user" },
                        "worker": "https://mnutze.github.io/bsc.monitor/assets/worker.learner_activities.js"
                    },
                    "options": { "selection": { "only": "learners", "single": true } },
                    "scroll": { "y": false },
                    "sources": { "log": { "filter": "ignore.filter.activities" } }
                ...
                "leaderboard": {
                    ...
                    "config": {
                        ...
                        "subject": {},
                        // runtime configuration
                        "range": { "enabled": true, "type": null, "range": "last 6 month" } // @TODO add to options -> range-types "lessons"{ "enabled": true, "range": "lessons" }
                    },
                    "options": {
                        "visualization": {
                            "label": "Visualization",
                        ...
                        "panel_1559646513933X30564639958612694": {
                            ...
                            "widgets": {
                                ...
                                "widget_198614237563X913236787272112": {
                                    "title": "Activities by Time-Range",
                                    "position": { "x": 4, "y": 6, "width": 3, "height": 6 },
                                ...
                                "widget_latest_513933X30564639958612": {
                                    ...
                                    "position": { "x": 5, "y": 0, "width": 7, "height": 6 },
                                    "widget": "ignore.widgets.latest_subject_activities"
                                }
                            }
                        },
...
//                                },
        ...
        "sources": {
            "log": { // { filter: {}, name: "", query: {}, url: "" }
                ...
                "main": true,
                "query": { "$and": [ { "user": { "$exists": true } }, { "user.user": { "$ne": "308cecce8e2115c780e374f13ecb4547" } } ] },
